...
├── views/                                    ├── MixinName.js          ← 구현체
│   └── 01_name.html        ← HTML 구조      ├── MixinName.md          ← API 문서
├── styles/                                   └── (5개 문서 갱신)
│   └── 01_name.css          ← CSS 스타일
├── scripts/
│   ├── register.js          ← 조립 코드      ◀ Hook 검사 대상
│   └── beforeDestroy.js     ← 정리 코드      ◀ Hook 검사 대상
└── preview/
    └── 01_name.html         ← 독립 테스트     ◀ Hook 검사 대상
```
