...
1. **승인된 명세서** — `docs/MIXIN_SPEC_EXAMPLE_[MixinName].md`
...
| [COMPONENT_SYSTEM_DESIGN.md](/RNBT_architecture/DesignComponentSystem/docs/COMPONENT_SYSTEM_DESIGN.md) | 네임스페이스 규칙 테이블 + Mixin 카탈로그 테이블 + 기능 정의 테이블에 추가. 미구현 후보에 있었으면 제거. |
| [MIXIN_REVIEW.md](/RNBT_architecture/DesignComponentSystem/docs/MIXIN_REVIEW.md) | 새 Mixin 섹션 추가 + 요약 테이블에 추가 |
| [SHARED_INSTRUCTIONS.md](/.claude/skills/SHARED_INSTRUCTIONS.md) | Mixin 문서 확인 규칙 테이블에 추가 |
| [SYSTEM_READINESS_REVIEW.md](/RNBT_architecture/DesignComponentSystem/docs/SYSTEM_READINESS_REVIEW.md) | Mixin 수 갱신 (N개 → N+1개) |
