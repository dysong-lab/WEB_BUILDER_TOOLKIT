...
3. [SHARED_INDEX.md](/.claude/skills/SHARED_INDEX.md) — 공통 인덱스
4. [SHARED_PATTERNS.md](/.claude/skills/SHARED_PATTERNS.md) — 공통 코드 패턴
5. [CODING_STYLE.md](/.claude/guides/CODING_STYLE.md) — 코딩 스타일
...
| [SHARED_INDEX.md](/.claude/skills/SHARED_INDEX.md) | Mixin 문서 확인 규칙 테이블에 추가 |
...
| 공통 규칙 | [SHARED_INDEX.md](/.claude/skills/SHARED_INDEX.md), [SHARED_PATTERNS.md](/.claude/skills/SHARED_PATTERNS.md) |
