...
대상 결정 규칙은 [`_shared/phase0-2d.md`](../_shared/phase0-2d.md)를 따른다. 범주 폴더 구조를 동적 감지하여 `{컴포넌트경로}` 후보 목록을 만들고, `register.js`가 없는 첫 번째 항목을 **다음 대상**으로 삼는다.

Phase 0 완료 후 **사용자에게 보고**: "다음 대상: {컴포넌트경로}/Standard"
