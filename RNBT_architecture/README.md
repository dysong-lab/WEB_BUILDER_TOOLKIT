...
참조: [DesignComponentSystem/Mixins/ComponentMixin.js](/RNBT_architecture/DesignComponentSystem/Mixins/ComponentMixin.js)
...
> **참고:** 컴포넌트의 register.js 내부 구조는 **Mixin 기반**으로 전환되었다. register.js는 Mixin 적용, 자체 메서드 정의, 구독 연결, 이벤트 매핑을 수행한다. Mixin과 자체 메서드 모두 cssSelectors 계약으로 DOM에 접근하며, beforeDestroy.js에서 정리한다. 상세는 [컴포넌트 라이프사이클 패턴](#컴포넌트-라이프사이클-패턴) 및 [COMPONENT_SYSTEM_DESIGN.md](/RNBT_architecture/DesignComponentSystem/docs/architecture/COMPONENT_SYSTEM_DESIGN.md) 참조.
...
> **상세 문서:** [INSTANCE_LIFECYCLE_GC.md](/RNBT_architecture/.legacy_ref/docs/INSTANCE_LIFECYCLE_GC.md)
