...
```javascript
datasetAttrs: {
    id:       'id',          // renderData가 data-id 설정 (updateItemState에서 항목 식별)
...
[
    {
        id:       '1',           // → cssSelectors['id'] + datasetAttrs['id'] → data-id="1"
        severity: 'warning',     // → cssSelectors['severity'] + datasetAttrs['severity'] → data-severity="warning"
        ack:      'false',       // → cssSelectors['ack'] + datasetAttrs['ack'] → data-ack="false"
