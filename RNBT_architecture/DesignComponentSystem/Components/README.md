...
| 컴포넌트 | Mixin | 설명 |
|----------|-------|------|
| BarChart | EChartsMixin | 막대 차트 |
| EventBrowser | ListRenderMixin + ShadowPopupMixin | 이벤트 목록 + 상세 팝업 |
| GaugeChart | EChartsMixin | 게이지 차트 |
| Header | FieldRenderMixin | 헤더 정보 표시 |
| LineChart | EChartsMixin | 라인 차트 |
| PieChart | EChartsMixin | 파이 차트 |
| Sidebar | StatefulListRenderMixin | 메뉴 항목 + 활성 상태 관리 |
| Table | TabulatorMixin | 데이터 테이블 |
