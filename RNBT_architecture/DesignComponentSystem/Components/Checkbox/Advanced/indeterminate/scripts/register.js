...
this._renderChildren = function (children) {
    ...
    this._childrenStates.forEach((selected, id) => this._applyChildDom(id, selected));
};

this._recomputeParentState = function () {
    const parent = this.appendElement.querySelector(this.listRender.cssSelectors.parent);
    const group = this.appendElement.querySelector(this.listRender.cssSelectors.group);
    const input = this.appendElement.querySelector(this.listRender.cssSelectors.parentInput);
...
this._renderGroup = function ({ response } = {}) {
    ...
    const parentLabel = this.appendElement.querySelector(this.listRender.cssSelectors.parentLabel);
