/**
 * BATT — Advanced/camera_highlight / scripts / register
 *
...
// ── 3D 이벤트 → 외부 전파 ─────────────────────────────────────
// `@battClicked`를 수신한 쪽(페이지)이 cameraFocus.focusOn({ meshName: 'BATT' }) +
// meshHighlight.clearAll() → meshHighlight.highlight('BATT')를 호출한다.
