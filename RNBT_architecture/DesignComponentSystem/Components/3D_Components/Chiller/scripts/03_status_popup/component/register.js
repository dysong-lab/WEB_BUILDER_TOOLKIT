/**
 * Chiller — 03_status_popup / component / register
 *
...
this.showDetail = () => {
    ...
    if (nameEl) nameEl.textContent = this.name || 'Chiller';
    if (statusEl) {
        const currentStatus = this.meshState.getMeshState('chiller') || 'normal';
