/**
 * tempHumiTH2B — 03_status_popup / component / register
 *
...
this.showDetail = () => {
    ...
    if (nameEl) nameEl.textContent = this.name || 'tempHumiTH2B';
    if (statusEl) {
        const currentStatus = this.meshState.getMeshState('tempHumiTH2B') || 'normal';
