/**
 * SC_01 — 01_status / scripts / register
 *
 * MeshStateMixin 단독 적용
 * 상태에 따라 "SC-2U1" 메시 색상 변경
 *
 * 장비 폴더명(SC_01)과 GLTF Mesh Node 이름(SC-2U1)이 다른 비대칭 명명 케이스.
 * RTU의 'RTU2', RoomCage의 'cage01', RoomCageSmall의 'cage02' 패턴과 동류로,
 * 구독 데이터의 meshName은 'SC-2U1'(하이픈 포함)을 사용한다.
 *
