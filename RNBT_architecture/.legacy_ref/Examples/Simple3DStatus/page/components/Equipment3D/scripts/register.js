...
this.meshStatusConfig = [
    { meshName: 'SHV-B-1', equipmentId: 'eq-001' },
    { meshName: 'SHV-B-2', equipmentId: 'eq-002' },
    { meshName: 'SHV-B-3', equipmentId: 'eq-003' },
    { meshName: 'SHV-B-4', equipmentId: 'eq-004' },
    { meshName: 'SHV-B-5', equipmentId: 'eq-005' },
    { meshName: 'SHV-B-6', equipmentId: 'eq-006' }
];
